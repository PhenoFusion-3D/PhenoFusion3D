...
class MainWindow(QMainWindow):
    ...
    def _connect_signals(self):
        ...
        # Mirror DataPanel state to controller for Quality Check.
        # mask_bg, tsdf_voxel, use_canopy, canopy_stride are reconstruction-only;
        # quality path sync only needs the first 10 params.
